...
#endif
KMP_EXPORT kmp_int32 __kmpc_dynamic_variant(char *variants_names[],
                                            kmp_int32 *traits, int numVariants,
...
KMP_EXPORT void __kmpc_instrument_variant_start();
KMP_EXPORT void __kmpc_instrument_variant_end(char variant_name[256]);
KMP_EXPORT void __kmpc_malloc_cpu_mem(void *addr, size_t size);
KMP_EXPORT void __kmpc_free_cpu_mem(void *addr);
KMP_EXPORT void __kmpc_init_instrumentation();
KMP_EXPORT void __kmpc_finish_instrumentation();
KMP_EXPORT int __kmpc_get_num_executions();
KMP_EXPORT void *malloc(size_t size);
KMP_EXPORT void __kmpc_register_variants_data(struct variant_data *variants_data, int num_variants);
#endif
#if TASK_UNUSED
