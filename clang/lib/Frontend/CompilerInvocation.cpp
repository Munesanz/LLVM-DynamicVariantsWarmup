...
#undef LANG_OPTION_WITH_MARSHALLING
  ...
  if (Opts.OpenMP && !Opts.OpenMPSimd) {
    ...
    if (Opts.OpenMPDynamicVariantWarmup){
      GenerateArg(Args, OPT_dynamic_variant_warmup, SA);
    }
...
#undef LANG_OPTION_WITH_MARSHALLING
  ...
  Opts.OpenMPDynamicVariant =
      Opts.OpenMP && (Args.hasArg(options::OPT_dynamic_variant) || Args.hasArg(options::OPT_dynamic_variant_warmup));
  Opts.OpenMPDynamicVariantWarmup =
      Opts.OpenMP && Args.hasArg(options::OPT_dynamic_variant_warmup);
  if (Opts.OpenMP) {
